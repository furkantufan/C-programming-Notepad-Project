//150201123 muhammed þara - 150201111 m.furkan tufan
...
void ekleme();//ekleme
void silme();// silme
void ekranayaz();//ekrana bas
void menu();
void kopyalayapistir();//kopyala yapistir

void dizi();//yukarydan asy?yya tututlan dizi
void yonlendirme();//yonler.
void sec();//ne oluca?yny sececek.
